<?php
	...
	$var_path = "https://system.bbcoop.or.th" ; 
    ...
    WHERE tb1.member_id = '{$member_id}' AND YEAR(tb2.receipt_datetime) = '{$year}' AND MONTH(tb2.receipt_datetime) = '{$month}' AND tb1.receipt_id = '{$inc_no}'
    ...
    if ( $rs->num_rows ) {
        ...
        while( ($row = $rs->fetch_assoc()) ){
            ...
            $data['data'][] = [
                ...
                'type' => ($row['types'] == 'รายเดือน' ) ? 'month' : 'other'
            ];
        }
