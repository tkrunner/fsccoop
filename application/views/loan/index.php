								...
								?>
									<tr> 
										...
										<?php
											...
											// echo '<br>'.$row_loan['loan_type'].' /'.@$row_loan['petition_file'].'/'.$row_loan['id'];
										?>
										</td> 
										<td><?php
												...
												<ul class="dropdown-menu">
													...
													<?php }else if(in_array($row_loan['loan_status'],array('0','1','4','7','8'))){ ?>
														<?php if($row_loan['loan_status']=='0' && $row_loan['guarantee_for_id']==''){ ?>
                                                            ...
                                                            <li><a title="แก้ไข" style="cursor:pointer;padding-left:2px;padding-right:2px" href="<?php echo base_url()."loan_contract?".$this->center_function->encrypt('member_id='.$_GET['member_id'].'&loan_id='.$row_loan['id'])?>" target="_self"><span style="cursor: pointer;" class="icon icon-edit"></span> แก้ไข</a></li>
                                                        <?php } ?>
