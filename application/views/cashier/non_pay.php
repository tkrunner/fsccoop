...
function add_row(){
	...
	new_row += "<td><input type='text' class='form-control non_pay_amount right' id='non_pay_amount_"+i+"' name='data[list_data]["+i+"][non_pay_amount]' onkeyup=\"keypress_non_pay_amount('"+i+"')\" onblur='format_the_number(this);' maxlength='10'></td>";
