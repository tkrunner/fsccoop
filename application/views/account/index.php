                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <span id="show_pay_type2" style="">
                                    <input type="radio" name="journal_type" id="pay_type_0" value="RV"> ด้านรับ &nbsp;&nbsp;
...
<script>
    $(document).ready(function() {
        $(document).on('keypress', '.acc_input', function (e) {
            if(e.which == 13) {
                $(this).trigger("change");
                form_cash_submit();
            }
        });
        $(document).on('keypress', '.debit_input , .credit_input', function (e) {
            if(e.which == 13) {
                $(this).trigger("change");
                if($(this).parents("table:first").attr('id') == 'account_data_sp_table') {
                    form_submit_sp();
                } else {
                    form_submit();
                }
        ...
        $("#btn-add-account-detail").click(function() {
            ...
            if(index == 6) {
                modal = $("#add_account_cash").find(".modal-body");
                div_h = modal.height();
