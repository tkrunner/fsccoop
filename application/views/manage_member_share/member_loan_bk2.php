											...
											<table class="table table-bordered table-striped table-center">
												...
												?>
													<tr> 
														...
														<td>
															<a href="<?php echo base_url(PROJECTPATH.'/admin/receipt_form_pdf/'.jwt::urlsafeB64Encode($this->center_function->encrypt_text(@$row_finance_detail['receipt_id']))); ?>" target="_blank"><?php echo @$row_finance_detail['receipt_id'];?></a>
														</td>
