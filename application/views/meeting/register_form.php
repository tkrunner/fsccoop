					...
					<tr>
						...
						<td class="text-center">
						 ...
						 <td style="width:150px;vertical-align: top;" class="text-right">
							...
							*/ ?>
							<a class="no_print"  target="_blank" href="<?php echo base_url('/meeting/register_form'.$get_param.'&type=pdf'); ?>">
				...
				<table class="table table-view table-center">
					<thead>
						<tr>
							...
							<th style="width: 150px;vertical-align: middle;">เบอร์โทร</th>
							<th style="width: 250px;vertical-align: middle;">ลายเซ็นต์</th>
						</tr>
					</thead>
					<tbody>
					...
					?>
							<tr>
							  ...
							  <td style="text-align: center;vertical-align: top;"><?php echo $row['mem_group']; ?></td>
							  <td style="text-align: center;vertical-align: top;"><?php echo $row['tel'];?></td>
