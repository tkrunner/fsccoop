			...
			<div class="panel panel-body" style="padding-top:10px !important;height: 1000px;">
				...
				<table class="table table-view table-center">
					...
					<?php
                        ...
                        foreach($loan_type AS $key=>$row_loan_type){
                            $all_loan_person[$loan_type['loan_type_code']] = 0;
                            $all_loan_balance[$loan_type['loan_type_code']] = 0;
                        }
						...
						if(!empty($data_row)){
							foreach(@$data_row as $key => $row){
                                ...
                                foreach ($set_loan_type as $loan_type_key => $loan_type) {
                                    $total_loan_person[$loan_type['loan_type_code']] += @$row['loan_person'][$loan_type['loan_type_code']];
                                    $total_loan_balance[$loan_type['loan_type_code']] += @$row['loan_balance'][$loan_type['loan_type_code']];
                                }
					...
					?>
							<tr>
							  ...
							  <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['share_collect'],2); ?></td>
                                ...
                                <?php foreach ($set_loan_type as $loan_type_key => $loan_type) {
                                    if ($loan_type['loan_type_code'] != 'atm'){?>
                                    <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_person'][$loan_type['loan_type_code']],0); ?></td>
                                    <td style="text-align: right;vertical-align: top;"><?php echo number_format(@$row['loan_balance'][$loan_type['loan_type_code']],2); ?></td>
                                <?php }} ?>
					...
					<?php
                        ...
                        foreach($set_loan_type AS $key=>$loan_type){
                            $all_loan_person[$loan_type['loan_type_code']] += $total_loan_person[$loan_type['loan_type_code']];
                            $all_loan_balance[$loan_type['loan_type_code']] += $total_loan_balance[$loan_type['loan_type_code']];
                        }
					...
					?>
						<tr>
						  ...
						  <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_share_collect,2); ?></td>
                            ...
                            <?php foreach($set_loan_type AS $key=>$loan_type){
                                if($loan_type['loan_type_code'] != 'atm'){ ?>
                              <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_person[$loan_type['loan_type_code']],0); ?></td>
                              <td style="text-align: right;vertical-align: top;" class="border-bottom"><?php echo number_format(@$all_loan_balance[$loan_type['loan_type_code']],2); ?></td>
                            <?php }} ?>
