				...
				<table class="table table-view table-center">
					...
					<tbody>
							...
							<td style="text-align: center;vertical-align: top;"><?php echo @$row['member_id'];?></td>
							  ...
							  ?>
							  <td style="text-align: center;vertical-align: top;"><?php echo (@$row['loan_emergent_atm_period_now'] !='')?number_format(@$row['loan_emergent_atm_period_now'],0):''; ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo @$row['loan_emergent_atm_contract_number']; ?></td> 					 
							  <td style="text-align: right;vertical-align: top;"><?php echo (@$row['loan_emergent_atm_balance'] !='')?number_format(@$row['loan_emergent_atm_balance'],2):''; ?></td> 					 
